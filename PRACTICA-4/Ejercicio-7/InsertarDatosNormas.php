...
<body>
    <section>
        ...
        <form method="post" action="" name="insertarDatos">
            ...
            <p><label for="distancia_interpersonal" >Distancia interpersonal:</label> <input type="double" name="distancia_interpersonal" id="distancia_interpersonal" required/></p>
